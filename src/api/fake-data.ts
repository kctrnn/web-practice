...
export const FAKE_CHALLENGE_LIST: Challenge[] = [
  {
    id: '0J1NxxGhOUYVqihwegfO',
    order: 5,
    designId: '4B0x88GhiZvgVlcQPSQ73D',
    updatedAt: 1613423042970,
    level: 0,
    brief:
    ...
    resourceId: 'checkout-page',
    name: 'Checkout Page',
  },
  {
    id: '3JFYedSOZqAxYuOCNmYD',
    thumbnailImage:
      'https://firebasestorage.googleapis.com/v0/b/devchallenges-1234.appspot.com/o/challengesDesigns%2FwindbnbThumbnail.png?alt=media&token=183d7d36-d216-4d30-9732-aa6e4ab0e8a5',
    description:
      'I love airbnb UI, it is so modern and clean. In this challenge, you will work with a similar UI to airbnb - windbnb.',
    brief:
    ...
    name: 'Windbnb',
    order: 3,
    updatedAt: 1613423001120,
    pathSlug: 'front-end-developer',
    designId: 'KGNH8dbclXT1vzXLyPrBeu',
  },
  {
    id: '5ZnOYsSXM24JWnCsNFlt',
    level: 2,
    order: 4,
    brief:
    ...
    designId: 'O7Omgz2iVR7Vox7shf7O8e',
    thumbnailImage:
    ...
    updatedAt: 1613423485514,
    name: 'Portfolio',
  },
  {
    id: '8Y3J4ucAMQpSnYTwwWW8',
    description:
      'Famous quotes can be a great source of motivation. This challenge is all about quotes.',
    brief:
      '**Challenge:** Create a quote generator app. Use Front-end libraries like React or Vue. Don’t look at the existing solution. Fulfill user stories below:\n\n- **User story:** I can see a random quote\n- **User story:** I generate a new random quote\n- **User story:** When I select quote author, I can see a list of quotes from them\n- **User story:** I can see quote genre under the author\n\n**Icon:** [https://google.github.io/material-design-icons/](https://google.github.io/material-design-icons/)\n\n**API:** [https://pprathameshmore.github.io/QuoteGarden/](https://pprathameshmore.github.io/QuoteGarden/)',
    order: 5,
    thumbnailImage:
      'https://firebasestorage.googleapis.com/v0/b/devchallenges-1234.appspot.com/o/challengesDesigns%2FquoteThumbnail.png?alt=media&token=156a0ff0-506a-4246-8422-eb1cedab5116',
    updatedAt: 1613423236672,
    name: 'Random quote generator',
    pathSlug: 'front-end-developer',
    level: 1,
    designId: 'FFxqnf1cEDiHhvFpN6u4hV',
    resourceId: 'quote-generator',
  },
  {
    id: 'Bu3G2irnaXmfwQ8sZkw8',
    level: 2,
    description:
      'If you want to learn more about countries, this challenge is perfect for you.',
    resourceId: 'country-quiz',
    pathSlug: 'front-end-developer',
    name: 'Country quiz',
    designId: 'Gw0ZNBbYN8asqFlZWy3jG1',
    order: 1,
    thumbnailImage:
      'https://firebasestorage.googleapis.com/v0/b/devchallenges-1234.appspot.com/o/challengesDesigns%2FcountryQuizThumbnail.png?alt=media&token=761f3109-120d-4111-96b3-98ef934281b6',
    brief:
      '**Challenge:** Create a country quiz app using an API. Use Front-end libraries like React or Vue. Don’t look at the existing solution. Fulfill user stories below:\n\n- **User story:** I can see at least 2 types of questions: `a city is the capital of..` or `a flag belong to country..`\n- **User story:** I can see select an answer \n- **User story:** I can see if my answer is correct or incorrect\n- **User story:** When I answer correctly, I can move on to the next question\n- **User story:** When I answer incorrectly, I can see my results and try again\n- **User story:** I can try again \n\n**Icon:** [https://google.github.io/material-design-icons/](https://google.github.io/material-design-icons/)\n\n**API:** [https://restcountries.eu/](https://restcountries.eu/). Use data from the API to create questions and answers.\n',
    updatedAt: 1613423278878,
  },
  {
    id: 'Jymh2b2FyebRTUljkNcb',
    description:
    ...
    designId: '3cf83hHRBAGjG5EKPcG2bV',
    pathSlug: 'responsive-web-developer',
    resourceId: 'interior-consultant',
    order: 2,
    brief:
    ...
    updatedAt: 1613423080595,
    name: 'Interior Consultant',
  },
  {
    id: 'N1fvBjQfhlkctmwj1tnw',
    name: 'Authentication App',
    order: 5,
    createdAt: 1596656557498,
    thumbnailImage:
      'https://firebasestorage.googleapis.com/v0/b/devchallenges-1234.appspot.com/o/challengesDesigns%2FAuthenticationAppThumbnail.png?alt=media&token=74f358e8-ccaf-43fc-b0fd-8b9732d80ba6',
    description:
    ...
    updatedAt: 1613423559742,
    resourceId: 'authentication-app',
    designId: 'ZM0DPZbzK39o3rqwiaOPTD',
    brief:
    ...
    level: 3,
    pathSlug: 'full-stack-developer',
  },
  {
    id: 'O2iGT9yBd6xZBrOcVirx',
    brief:
    ...
    name: 'Image Uploader',
    updatedAt: 1613423507782,
    pathSlug: 'full-stack-developer',
    resourceId: 'image-uploader',
    level: 2,
    thumbnailImage:
      'https://firebasestorage.googleapis.com/v0/b/devchallenges-1234.appspot.com/o/challengesDesigns%2FImageUploaderThumbnail.png?alt=media&token=f32259ea-dd8f-4146-9a89-6e3c817b3167',
    createdAt: 1598901850498,
    description:
    ...
    designId: 'NxbZm3CAovYh89dFXe7EOw',
    order: 6,
  },
  {
    id: 'OEKdUZ6xs0h99C38XVht',
    level: 0,
    thumbnailImage:
    ...
    resourceId: 'recipe-page',
    order: 3,
    updatedAt: 1613423067086,
    designId: '2jVBTSKeCYF0dIN6fi0stX',
  },
  {
    id: 'TSqutYM4c5WtluM7QzGp',
    level: 1,
    name: 'Input component',
    resourceId: 'input-component',
    designId: 'slzHnI05qpbBeC33ZMZGa5',
    order: 1,
    description:
      'One of the best ways to learn front-end libraries is to create reusable component. In this challenge, your task is to create a reusable input.',
    thumbnailImage:
      'https://firebasestorage.googleapis.com/v0/b/devchallenges-1234.appspot.com/o/challengesDesigns%2FInputThumbnail.png?alt=media&token=73685593-9026-42a6-8c68-00243071250e',
    brief:
  ...
  },
  {
    ...
    name: 'Todo app',
    resourceId: 'todo-app',
    updatedAt: 1613423212626,
    thumbnailImage:
      'https://firebasestorage.googleapis.com/v0/b/devchallenges-1234.appspot.com/o/challengesDesigns%2FtodoThumbnail.png?alt=media&token=67a62272-6021-49de-ab19-cda0344d643c',
    order: 4,
    level: 1,
    designId: 'SClDA1weEGA3Mo8Is8Sbf2',
  },
  {
    id: 'hhmesazsqgKXrTkYkt0U',
    designId: 'F8d1qJsorEdY47N74HLxQ4',
    description:
    ...
    resourceId: 'my-team-page',
    updatedAt: 1610800025087,
    thumbnailImage:
  ...
  },
  {
    ...
    pathSlug: 'front-end-developer',
    order: 2,
    designId: '5X3Ao3gEqZPqqKctP7riDF',
  },
  {
    id: 'ohgVTyJCbm5OZyTB2gNY',
    updatedAt: 1613423708902,
    order: 0,
    description:
    ...
    resourceId: 'button-component',
    thumbnailImage:
      'https://firebasestorage.googleapis.com/v0/b/devchallenges-1234.appspot.com/o/challengesDesigns%2FButtonThumbnail.png?alt=media&token=3ddbedcf-a08b-4144-928f-e551b4bcee80',
    brief:
    ...
    designId: 'vfMDJhGGnqfaskO2aud06o',
  },
  {
    id: 'rYyhwJAxMfES5jNQ9YsP',
    brief:
    ...
    level: 3,
    thumbnailImage:
      'https://firebasestorage.googleapis.com/v0/b/devchallenges-1234.appspot.com/o/challengesDesigns%2FMyUnsplashThumnail.png?alt=media&token=c5b12585-454b-4a68-9b3c-356a8a643d9f',
    resourceId: 'my-unsplash',
    updatedAt: 1613423520102,
    order: 1,
    designId: 'a1xUD6nInLKRz6evFKKdir',
    pathSlug: 'full-stack-developer',
    description:
      'This is the first challenge in the Full-stack path. You will create a basic API and create Unsplash-inspired design',
    name: 'My Unsplash',
  },
  {
    id: 'rleoQc34THclWx1cFFKH',
    description:
      'Recreating Twitter, the task sounds intimidating. But trust me, you will learn and have a lot of fun doing this. This challenge is a simple version of Twitter, it will test your skill in both Front-end and Back-end at a high level.',
    name: 'Tweeter - Twitter Clone',
    updatedAt: 1613423619062,
    brief:
      "**Challenge:** Create a Twitter clone app - Tweeter. Use any front-end libraries of your choice. Create your API. Don’t look at the existing solution. Fulfill user stories below:\n\n\n- **User story:** I can see my profile or others' profile\n- **User story:** When I am on a profile, I can see Tweets and Retweets. I can also filter by `Tweets`, `Tweets and replies`, `Media` and `Likes`\n- **User story:** When I am on a profile, I can see `followers` and `following`\n- **User story:** When I am on a profile, I can see `follow` or `unfollow` the user\n- **User story:** I can navigate between `Home`, `Explore` and `Bookmarks`\n- **User story:** I can navigate to `My Profile`, `Group Chat` (optional), `Setting/Authentication App`.\n- **User story:** When I am on `Home`, I can post a new Tweet\n- **User story:** When I post a new Tweet, I can choose to upload an image and set the Tweet to be `public` or `only-follower`\n- **User story:** When I am on `Home`, I can see Tweets of people who I follow\n- **User story:** I can `Comment`, `Retweet`, `Like` or `Save` a Tweet\n- **User story:** I can `Comment` with image and I can like a comment\n- **User story:** I can see the posted time of the `Comments` and `Tweets`\n- **User story:** When I am on `Home`, I can see the most popular `hashtags` and people I should follow (it's up to you how to implement this)\n- **User story:** When I am on `Explore`, I can see the `Top`, `Latest` Tweet, or Tweet with Media. I can also choose to see the most popular people\n- **User story:** When I am on `Bookmarks`, I can see the `Saved` Tweet\n\n\n- **User story(optional):** I can search for a group\n\nYou can use the [Authentication Challenge](https://devchallenges.io/challenges/N1fvBjQfhlkctmwj1tnw) or create your own authentication application for this challenge.\n\nYou can check out [Twitter](https://twitter.com/home) for the interactions.\n\n**Icon:** [https://google.github.io/material-design-icons/](https://google.github.io/material-design-icons/)",
    designId: 'xxf4TG14lpF3vFUbBtEZUR',
    createdAt: 1598786431515,
    resourceId: 'tweeter',
    thumbnailImage:
      'https://firebasestorage.googleapis.com/v0/b/devchallenges-1234.appspot.com/o/challengesDesigns%2FTweeterThumbnail.png?alt=media&token=c49105bd-1854-4a6e-ab18-ca424a325332',
    level: 5,
    order: 1,
    pathSlug: 'full-stack-developer',
  },
  {
    id: 'wBunSb7FPrIepJZAg0sY',
    level: 0,
    thumbnailImage:
  ...
  },
  {
    ...
    level: 1,
    name: 'Edie homepage',
    resourceId: 'edie-homepage',
    order: 7,
    updatedAt: 1613423115714,
  },
];
